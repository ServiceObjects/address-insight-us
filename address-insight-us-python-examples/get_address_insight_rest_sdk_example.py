...
sys.path.insert(0, os.path.abspath("../address-insight-us-python/REST"))

from get_address_insight_rest import get_address_insight


def get_address_insight_rest_sdk_go(is_live: bool, license_key: str) -> None:
    print("\r\n---------------------------------------------------")
    print("Address Insight - US - GetAddressInsight - REST SDK")
    print("---------------------------------------------------")
