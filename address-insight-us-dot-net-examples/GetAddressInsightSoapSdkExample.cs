using AIUSReference;
using address_insight_us_dot_net.SOAP;

namespace address_insight_us_dot_net_examples
{
    public static class GetAddressInsightSoapSdkExample
    {
        public static void Go(string licenseKey, bool isLive)
        {
            Console.WriteLine("\r\n---------------------------------------------------");
            Console.WriteLine("Address Insight – US - GetAddressInsight - SOAP SDK");
            Console.WriteLine("---------------------------------------------------");
            ...
            GetAddressInsightValidation ain = new GetAddressInsightValidation(isLive);
            ...
            if (response != null && !response.ContainsKey("Error"))
            {
                ...
                Console.WriteLine($"FragmentUnit           : {(response["AddressInsightResponse"][0]["FragmentUnit"])}");
